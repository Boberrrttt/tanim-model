...
TIMELINE_TEMPLATES: Dict[str, Dict[str, Any]] = {
    ...
    "RICE": _four_phase(
        ...
        "IRRI-style: short <120 d, medium 120–140 d, long 160+ d — template ~125 d (medium-short); adjust for cultivar and transplant vs DSR.",
    ),
    "WHEAT": _four_phase(
        115,
